<?php if (count($this->images) > 7) : ?>
    ...
    <div id="cover-wrapper">
            ...
            <div id="first-block" class="img">
                <?php if (isset($this->images[0])) : ?>
                    <a href="<?php echo Engine_Api::_()->getItem('whmedia_media', $this->images[0]->parent_id)->getParent()->getHref() ?>">
                        <img class="curve-topleft-image" src="<?php echo $this->baseUrl() . '/whshow_thumb.php?cz=1&w=220&h=205&src=' . $this->images[0]->storage_path ?>" />
                    </a>
                <?php endif ?>
                <?php if (isset($this->images[5])) : ?>
                    <a style="opacity: 0; display:none" href="<?php echo Engine_Api::_()->getItem('whmedia_media', $this->images[5]->parent_id)->getParent()->getHref() ?>">
                        <img class="curve-topleft-image" src="<?php echo $this->baseUrl() . '/whshow_thumb.php?cz=1&w=220&h=205&src=' . $this->images[5]->storage_path ?>" />
                    </a>
                <?php endif ?>
            </div>
            <div id="second-block" class="img">
                <?php if (isset($this->images[10])) : ?>
                    <a href="<?php echo Engine_Api::_()->getItem('whmedia_media', $this->images[10]->parent_id)->getParent()->getHref() ?>">
                        <img src="<?php echo $this->baseUrl() . '/whshow_thumb.php?cz=1&w=220&h=205&src=' . $this->images[10]->storage_path ?>" />
                    </a>
                <?php endif ?>
                <?php if (isset($this->images[15])) : ?>
                    <a style="opacity: 0; display:none" href="<?php echo Engine_Api::_()->getItem('whmedia_media', $this->images[15]->parent_id)->getParent()->getHref() ?>">
                        <img src="<?php echo $this->baseUrl() . '/whshow_thumb.php?cz=1&w=220&h=205&src=' . $this->images[15]->storage_path ?>" />
                    </a>
                <?php endif ?>
            </div>
        </div>
        ...
        <div id="second-column">
            <div id="third-block" class="img">
                ...
                <?php if (isset($this->images[6])) : ?>
                    <a style="opacity: 0; display:none" href="<?php echo Engine_Api::_()->getItem('whmedia_media', $this->images[6]->parent_id)->getParent()->getHref() ?>">
            ...
            <div id="fourth-block" class="img">
                <?php if (isset($this->images[11])) : ?>
                    <a href="<?php echo Engine_Api::_()->getItem('whmedia_media', $this->images[11]->parent_id)->getParent()->getHref() ?>">
                        <img src="<?php echo $this->baseUrl() . '/whshow_thumb.php?cz=1&w=220&h=205&src=' . $this->images[11]->storage_path ?>" />
                    </a>
                <?php endif ?>
                <?php if (isset($this->images[16])) : ?>
                    <a style="opacity: 0; display:none" href="<?php echo Engine_Api::_()->getItem('whmedia_media', $this->images[16]->parent_id)->getParent()->getHref() ?>">
                        <img src="<?php echo $this->baseUrl() . '/whshow_thumb.php?cz=1&w=220&h=205&src=' . $this->images[16]->storage_path ?>" />
                    </a>
                <?php endif ?>
            </div>
        </div>
            ...
            <div id="fifth-block" class="img">
                <?php if (isset($this->images[2])) : ?>
                    <a href="<?php echo Engine_Api::_()->getItem('whmedia_media', $this->images[2]->parent_id)->getParent()->getHref() ?>">
                        <img src="<?php echo $this->baseUrl() . '/whshow_thumb.php?cz=1&w=220&h=205&src=' . $this->images[2]->storage_path ?>" />
                    </a>
                <?php endif ?>
                <?php if (isset($this->images[7])) : ?>
                    <a style="opacity: 0; display:none" href="<?php echo Engine_Api::_()->getItem('whmedia_media', $this->images[7]->parent_id)->getParent()->getHref() ?>">
                        <img src="<?php echo $this->baseUrl() . '/whshow_thumb.php?cz=1&w=220&h=205&src=' . $this->images[7]->storage_path ?>" />
                    </a>
                <?php endif ?>
            </div>
            <div id="six-block" class="img">
                <?php if (isset($this->images[12])) : ?>
                    <a href="<?php echo Engine_Api::_()->getItem('whmedia_media', $this->images[12]->parent_id)->getParent()->getHref() ?>">
                        <img src="<?php echo $this->baseUrl() . '/whshow_thumb.php?cz=1&w=220&h=205&src=' . $this->images[12]->storage_path ?>" />
                    </a>
                <?php endif ?>
                <?php if (isset($this->images[17])) : ?>
                    <a style="opacity: 0; display:none" href="<?php echo Engine_Api::_()->getItem('whmedia_media', $this->images[17]->parent_id)->getParent()->getHref() ?>">
                        <img src="<?php echo $this->baseUrl() . '/whshow_thumb.php?cz=1&w=220&h=205&src=' . $this->images[17]->storage_path ?>" />
                    </a>
                <?php endif ?>
            </div>
        </div>
        ...
        <div id="fourth-column">
            <div id="seven-block" class="img">
                ...
                <?php if (isset($this->images[8])) : ?>
                    <a style="opacity: 0; display:none" href="<?php echo Engine_Api::_()->getItem('whmedia_media', $this->images[8]->parent_id)->getParent()->getHref() ?>">
                        <img src="<?php echo $this->baseUrl() . '/whshow_thumb.php?cz=1&w=220&h=205&src=' . $this->images[8]->storage_path ?>" />
                    </a>
                <?php endif ?>
            </div>
            <div id="eight-block" class="img">
                <?php if (isset($this->images[13])) : ?>
                    <a href="<?php echo Engine_Api::_()->getItem('whmedia_media', $this->images[13]->parent_id)->getParent()->getHref() ?>">
                        <img src="<?php echo $this->baseUrl() . '/whshow_thumb.php?cz=1&w=220&h=205&src=' . $this->images[13]->storage_path ?>" />
                    </a>
                <?php endif ?>
                <?php if (isset($this->images[18])) : ?>
                    <a style="opacity: 0; display:none" href="<?php echo Engine_Api::_()->getItem('whmedia_media', $this->images[18]->parent_id)->getParent()->getHref() ?>">
                        <img src="<?php echo $this->baseUrl() . '/whshow_thumb.php?cz=1&w=220&h=205&src=' . $this->images[18]->storage_path ?>" />
                    </a>
                <?php endif ?>
            </div>
        </div>
        ...
        <div id="fifth-column">
            <div id="nine-block" class="img">
                <?php if (isset($this->images[4])) : ?>
                    <a href="<?php echo Engine_Api::_()->getItem('whmedia_media', $this->images[4]->parent_id)->getParent()->getHref() ?>">
                        <img class="curve-topRight-image" src="<?php echo $this->baseUrl() . '/whshow_thumb.php?cz=1&w=220&h=205&src=' . $this->images[4]->storage_path ?>" />
                    </a>
                <?php endif ?>
                <?php if (isset($this->images[9])) : ?>
                    <a style="opacity: 0; display:none" href="<?php echo Engine_Api::_()->getItem('whmedia_media', $this->images[9]->parent_id)->getParent()->getHref() ?>">
                        <img class="curve-topRight-image" src="<?php echo $this->baseUrl() . '/whshow_thumb.php?cz=1&w=220&h=205&src=' . $this->images[9]->storage_path ?>" />
                    </a>
                <?php endif ?>
            </div>
            <div id="ten-block" class="img">
                <?php if (isset($this->images[14])) : ?>
                    <a href="<?php echo Engine_Api::_()->getItem('whmedia_media', $this->images[14]->parent_id)->getParent()->getHref() ?>">
                        <img src="<?php echo $this->baseUrl() . '/whshow_thumb.php?cz=1&w=220&h=205&src=' . $this->images[14]->storage_path ?>" />
                    </a>
                <?php endif ?>
                <?php if (isset($this->images[19])) : ?>
                    <a style="opacity: 0; display:none" href="<?php echo Engine_Api::_()->getItem('whmedia_media', $this->images[19]->parent_id)->getParent()->getHref() ?>">
                        <img src="<?php echo $this->baseUrl() . '/whshow_thumb.php?cz=1&w=220&h=205&src=' . $this->images[19]->storage_path ?>" />
                    </a>
                <?php endif ?>
            </div>
        </div>
