...
class Core_Widget_MenuMiniController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    if( $viewer->getIdentity() )
    {
      $this->view->hasNotifications = Engine_Api::_()->getDbtable('notifications', 'activity')->hasRequestOrNotification($viewer); 
      $this->view->hasRequestNot = Engine_Api::_()->getDbtable('notifications', 'activity')->hasRequestOrNotification($viewer, true); 
