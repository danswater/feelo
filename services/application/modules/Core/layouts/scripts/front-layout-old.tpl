...
<head>
  ...
  <style type="text/css">
    ...
    html#smoothbox_window{background: #34c9e8; !important;}
    .footer{ padding-top: 200px;}
    .footer-content ul{list-style: none; padding: 0; margin: 0px 50px; }
    #footer-left { float: left;}
    #footer-right { float: right;}
    .footer-content ul li{ float: left; padding: 10px; color: #fff; font-weight: bold;}
    .img-logo{width:auto; text-align:center; padding: 0px; margin: 100px 0px 0px 0px; }
  </style>
...
<body id="global_page_<?php echo $identity ?>">
  ...
  <div class="img-logo">
      <img src="<?php echo $this->layout()->staticBaseUrl ?>public/admin/big-yambai-logo.png">
  </div>

  <span id="global_content_simple">
    <?php echo $this->layout()->content ?>
  </span>
  <div id="global_footer" class="footer">
