...
if (!$this->_public)
    ...
    $this->addElement('Radio', 'create', array(
      'label' => 'Create Media Projects',
      'description' => 'Do you want to allow this user level to create media projects?',
      'multiOptions' => array(
        1 => 'Yes, allow this user level to create media projects.',
        0 => 'No, deny this user level to create media projects.'
      ),
    ...
    $this->addElement('Text', 'medias_count', array(
      'label' => 'Max number of media files in a Project',
      'description' => 'How many media users can add to project? The field must contain an integer, use zero for unlimited.',
      'value' => 10,
      'required' => true,
      ...
      $this->addElement('MultiCheckbox', 'file_type', array(
        'label' => 'File Types',
        'description' => 'Choose what file types can be added to projects by users.',
        'multiOptions' => array(
          'image' => 'Image',
    ...
    // Element: comment
      $this->addElement('Radio', 'comment', array(
        'label' => 'Allow Comments on Projects',
    ...
    // Element: auth_view
      $this->addElement('MultiCheckbox', 'auth_view', array(
        ...
        'description' => "Your members can choose from any of the options checked below when they decide who can see their project entries. These options appear on your members 'Create a Project' and 'Edit Project' pages. If you do not check any options, everyone will be allowed to view project.",
        'multiOptions' => array(
          'everyone'            => 'Everyone',
