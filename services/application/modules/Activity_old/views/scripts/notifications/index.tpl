  ...
  <div class='notifications_leftside'>
    ...
    <ul class='notifications' id="notifications_main">
      ...
      <!-- commented -->
        ...
        <table width="100%">
          <tr>
            <td style="width:50px">{item:$subject:$photo}</td>
            <td>{item:$subject:$photo} has commented on your {item:$object:$label}.</td>
            <td style="width:50px">{item:$object:$photo}</td>
          </tr>
        </table>
      </li>
      <!-- commented commented -->
        ...
        <table width="100%">
          <tr>
            <td style="width:50px">{item:$subject:$photo}</td>
            <td>{item:$subject} has commented on a {item:$object:$label} you commented on. </td>
            <td style="width:50px">{item:$object:$photo}</td>
          </tr>
        </table>
      </li>
      <!-- friend accepted -->
        ...
        <table width="100%">
          <tr>
            <td style="width:50px">{item:$subject:$photo}</td>
            <td>You and {item:$subject} are now friends.</td>
       ...
       <!-- friend_follow -->
        ...
        <table width="100%">
          <tr>
            <td style="width:50px">{item:$subject:$photo}</td>
            <td>{item:$subject} is now following you.</td>
            <td style="width:50px"></td>
          </tr>
        </table>
      </li>

      <!-- friend_follow_accepted -->
      </li>
        <table width="100%">
          <tr>
            <td style="width:50px">{item:$subject:$photo}</td>
            <td>You are now following {item:$subject}.</td>
            <td style="width:50px"></td>
          </tr>
        </table>
      </li>

      <!-- friend_follow_request -->
      </li>
        <table width="100%">
          <tr>
            <td style="width:50px">{item:$subject:$photo}</td>
            <td>{item:$subject} has requested to follow you.</td>
            <td style="width:50px"></td>
          </tr>
        </table>
      </li>
      ...
      <!-- friend_request -->
        ...
        <table width="100%">
          <tr>
            <td style="width:50px">{item:$subject:$photo}</td>
            <td>{item:$subject} has requested to be your friend.</td>
            <td style="width:50px"></td>
          </tr>
        </table>
      </li>
      ...
      <!-- liked -->
        ...
        <table width="100%">
          <tr>
            <td style="width:50px">{item:$subject:$photo}</td>
            <td>{item:$subject} likes your {item:$object:$label}.</td>
            <td style="width:50px">{item:$object:$photo}</td>
          </tr>
        </table>
      </li>
      ...
      <!-- liked_commented -->
        ...
        <table width="100%">
          <tr>
            <td style="width:50px">{item:$subject:$photo}</td>
            <td>{item:$subject} has commented on a {item:$object:$label} you liked.</td>
            <td style="width:50px">{item:$object:$photo}</td>
          </tr>
        </table>
      </li>
      ...
      <!-- message_new -->
        ...
        <table width="100%">
          <tr>
            <td style="width:50px">{item:$subject}</td>
            <td>{item:$subject} has sent you a {item:$object:message}.</td>
            <td style="width:50px">{item:$object:$photo}</td>
          </tr>
        </table>
      </li>
      ...
      <!-- post_user -->
        ...
        <table width="100%">
          <tr>
            <td style="width:50px">{item:$subject:$photo}</td>
            <td>{item:$subject} has posted on your {item:$object:profile}.</td>
            <td style="width:50px">{item:$object:$photo}</td>
          </tr>
        </table>
      </li>
      ...
      <!-- tagged -->
        ...
        <table width="100%">
          <tr>
            <td style="width:50px">{item:$subject:$photo}</td>
            <td>{item:$subject} <span>tagged you in a</span> {item:$object:$label}.</td>
            <td style="width:50px">{item:$object:$photo}</td>
          </tr>
        </table>
      </li>
      ...
      <!-- whmedia_processed_failed -->
      </li>
        <table width="100%">
          <tr>
            <td style="width:50px">{item:$object:$photo}</td>
            <td>Your media file has failed to process in< {item:$object:$label}.</td>
            <td style="width:50px"></td>
          </tr>
        </table>
      </li>
      ...
      <?php if( $this->notifications->getTotalItemCount() > 0 ): ?>
        <?php
          foreach( $this->notifications as $notification ):
            $notificationContent = $notification->__toString();
