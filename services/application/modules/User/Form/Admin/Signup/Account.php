...
class User_Form_Admin_Signup_Account extends Engine_Form
{
  public function init()
  {
    ...
    // Element: username
    $this->addElement('Radio', 'facebook', array(
      'label' => 'Enable Facebook Signup?',
      'description' => 'USER_FORM_ADMIN_SIGNUP_FACEBOOK_DESCRIPTION',
      'multiOptions' => array(
        1 => 'Yes, allow members to signup using facebook.',
        0 => 'No, do not allow facebook signup.'
      ),
      'value' => 1,
    ));	
