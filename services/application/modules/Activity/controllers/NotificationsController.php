...
class Activity_NotificationsController extends Core_Controller_Action_Standard
{
  ...
  public function updateAction()
  {
    ...
    $this->view->text = $this->view->translate(array('%s', '%s', $notificationCount), $notificationCount);
  }
  ...
  public function pulldownAction()
  {
    ...
    $viewer = Engine_Api::_()->user()->getViewer();
    $this->view->notifications = $notifications = Engine_Api::_()->getDbtable('notifications', 'activity')->getNotificationsPaginator($viewer, $type);
