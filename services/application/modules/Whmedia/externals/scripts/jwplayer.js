...
//			u.height = j(u.height);
//			u.width = j(u.width);
			//u.height = 500; // 360 comment this if adjustable
			u.width = 650;
			/* adjustable height */			
			var ratio = 0;
			if( typeof u.origHeight == "undefined" || typeof u.origWeight == "undefined" ){
				u.height = 500;
			}else{
				var origHeight = parseInt( u.origHeight ), 
					origWeight = parseInt( u.origWeight ),
					newWidth, newHeight;
				var ratio = origWeight/origHeight;
				u.height =	u.width/ratio;
				if(u.height > 500){
					u.height = 500;
				}
