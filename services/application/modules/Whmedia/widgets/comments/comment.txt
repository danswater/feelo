  ...
  <div class='comments_options'>
    ...
    <?php if( $this->viewer()->getIdentity() && $this->canComment ): ?>
      <?php if( $this->subject()->likes()->isLike($this->viewer()) ): ?>
        - <a href="javascript:void(0);" class="unlike_proj" onclick="en4.core.comments.unlike('<?php echo $this->subject()->getType()?>', '<?php echo $this->subject()->getIdentity() ?>'); this.addClass('like_proj')"></a>
      <?php else: ?>
        - <a href="javascript:void(0);" class="like_proj" onclick="en4.core.comments.like('<?php echo $this->subject()->getType()?>', '<?php echo $this->subject()->getIdentity() ?>'); this.addClass('unlike_proj')"></a>
      <?php endif; ?>
    <?php endif; ?>
  </div>
  <ul>
