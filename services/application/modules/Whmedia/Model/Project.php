...
class Whmedia_Model_Project extends Core_Model_Item_Abstract
{
   ...
   public function getHref() {
       ...
       return "/main/post/" . $this->project_id;
    /*
  ...
  public function getMedias(array $addition_filtr = null) {
    ...
    //echo "<pre>" . print_r($this->_medias, true) . "</pre>";
        return $this->_medias;
  }
  ...
  public function getMedia () {
    ...
    $dbTableMedia = Engine_Api::_()->getDbtable('medias', 'whmedia');
    $select = $dbTableMedia->select();
    $select->from( $selectedFrom, $selectedColumn );
    $select->where( 'project_id = ?', $this->project_id  );
    return $dbTableMedia->fetchRow( $select );
  }   
