...
<style type="text/css">
  #custom-signup-form{width: 504px; background: #fff; margin: 100px auto; border-radius:5px; }
  ...
  #error-message{padding-bottom: 20px; text-align: center; color: #ff0018; }
	...
	<div id="signup-header-form">
      <p>If you already have an account, please enter your details below.</p>
      <p>If you dont have one yet, please <a href="javascript:void(0)" onclick="parent.window.location.href='<?php echo $this->layout()->staticBaseUrl ?>signup'"><b>sign up</b></a> first.</p>
    </div>
    ...
    <?php endif; ?>
    <form action="<?php echo $this->layout()->staticBaseUrl ?>login-pop-up/format/smoothbox" id="user_form_login" enctype="application/x-www-form-urlencoded"  method="post">
