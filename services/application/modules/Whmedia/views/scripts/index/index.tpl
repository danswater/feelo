            ...
            <div class="media-proj-img">
                <?php if ($this->viewer()->getIdentity()): ?>
                    <?php if (!$whmedia->isOwner($this->viewer()))
                            echo $this->htmlLink(array('route' => 'default', 'module' => 'whmedia', 'controller' => 'share-project', 'action' => 'repost', 'project_id' => $whmedia->getIdentity(), 'reset' => true), '', array('class' => 'media-repost-icon smoothbox')); ?>       
                    ...
                    <div class="media-about-author">
                        <div class="media-author-thumb">
                            ...
                            <?php if ($whmedia->getOwner()->getIdentity() != $this->viewer()->getIdentity()): ?>
                                ...
                                <?php else: ?>    
                                    <?php echo $this->htmlLink(array('route' => 'whmedia_user_login'), $this->translate('Follow'), array('class' => 'smoothbox')) ?>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
