...
class Api_AuthController extends Zend_Rest_Controller {
    ...
    /**
     * @description 
     *  For user access right
     *
     * @param $user {User_Model_User}
     */
    public function getAccessRight( $user ){
        $_roles  = array('owner', 'member', 'network', 'registered', 'everyone');
    ...
    */
    public function postAction() {
		...
		if( $response[ "success" ] === true ) {
            ...
            // added access right by jose
            $user = Engine_Api::_ ()->user ()->getUser ( $result[ 'User'][ 'user_id' ] );
            $result[ 'User' ][ 'access_right'] = $this->getAccessRight( $user );
