...
class Api_HashtagpostsController extends Zend_Rest_Controller {
    ...
    public function postAction() {
		...
		$arrResultSet         = $projectFeed->fetchFeed( $user, 'hashtag', $this->_getParam( 'offset', null ), $this->_getParam( 'tag_id', null ) );
