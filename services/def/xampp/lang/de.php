...
$TEXT['global-xampp']="XAMPP für Mac OS X";
...
$TEXT['security-checkftppassword-text']="Wenn Du ProFTPD im XAMPP aktiviert hast, dann kannst Du standardmäßig mit dem Benutzernamen 'nobody' und dem Passwort 'xampp' Dateien für Deinen Webserver hochladen. Potentiell kann das nun natürlich jeder und daher sollte hier unbeding ein anderes Passwort gesetzt werden.";

// ---------------------------------------------------------------------
// START
// ---------------------------------------------------------------------

$TEXT['start-head']="Willkommen zu XAMPP für Mac OS X";
...
$TEXT['start-text4']="Viel Spaß,<br>Kristian Marcroft, Florian Pollini, Christian Speich & Team";
