...
$TEXT['global-xampp']="XAMPP voor Mac OS X";
...
$TEXT['security-checkftpwachtwoord-nok']="Het FTP wachtwoord voor gebruiker nobody is 'xampp'";
$TEXT['security-checkftpwachtwoord-ok']="Het FTP wachtwoord voor gebruiker nobody is niet langer 'xampp'";
...
$TEXT['start-head']="Welkom bij XAMPP voor Mac OS X";
...
$TEXT['start-text3']="Als u wilt beginnen met programmeren in PHP or Perl (of wat dan ook) kijk dan eerst in de <a target=extern href=http://www.apachefriends.org/xampp-en.html>XAMPP handleiding</a> en doe daar meer informatie op over uw XAMPP installatie.";

$TEXT['start-text4']="Succes,<br>Kristian Marcroft, Florian Pollini, Christian Speich & Team";
