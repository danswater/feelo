...
$TEXT['global-xampp']="XAMPP pour Mac OS X";
...
$TEXT['security-checkmysql-text']="Tout utilisateur local sur une machine Mac OS X peut acceder a votre base de donnees MySQL avec les droits administrateur. Vous devriez mettre un mot de passe.";

$TEXT['security-checkftppassword-nok']="Le mot de passe pour l'utilisateur FTP nobody est toujours 'xampp'";
$TEXT['security-checkftppassword-ok']="Le mot de passe pour l'utilisateur FTP nobody n'est plus 'xampp'";
...
$TEXT['start-head']="Bienvenue dans XAMPP pour Mac OS X";
...
$TEXT['start-text3']="Avant de commencer à programmer en PHP ou en Perl (ou autre ;),  allez voir le fichier <a href=http://www.apachefriends.org/xampp-en.html>XAMPP lisez-moi</a> pour avoir plus d'informations sur votre installation XAMPP.";
...
$TEXT['start-text6']="Bonne chance,<br>Kristian Marcroft, Florian Pollini, Christian Speich & Team";
