...
$TEXT['global-xampp']="XAMPP para Mac OS X";
...
$TEXT['security-checkftppassword-nok']="La contraseña del usuario FTP nobody todavia es 'xampp'";
$TEXT['security-checkftppassword-ok']="La contraseña del usuario FTP nobody ya no es 'xampp'";
...
$TEXT['start-head']="Bienvenido a XAMPP para Mac OS X";
...
$TEXT['start-text3']="Si quieres comenzar a programar en PHP o en Perl (u otro ) ; por favor echa un vistazo en <a target=extern href=http://www.apachefriends.org/xampp-en.html>XAMPP manual</a> primero e informate mas ampliamente sobre tu instalacion XAMPP.";

$TEXT['start-text4']="Buena suerte,<br>Kristian Marcroft, Florian Pollini, Christian Speich & Team";
