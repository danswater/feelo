...
$TEXT['global-xampp']="XAMPP for Mac OS X";
...
$TEXT['security-checkmysql-text']="Every local user on Mac OS X box can access your MySQL database with administrator rights. You should set a password.";

$TEXT['security-checkftppassword-nok']="The FTP password for user nobody is still 'xampp'";
$TEXT['security-checkftppassword-ok']="The FTP password for user nobody is no langer 'xampp'";
...
$TEXT['start-head']="Welcome to XAMPP for Mac OS X";
...
$TEXT['start-text3']="If you want to start programming PHP or Perl (or whatever ;) please take a look at the <a target=extern href=http://www.apachefriends.org/xampp-en.html>XAMPP manual</a> first and get more information about your XAMPP installation.";

$TEXT['start-text4']="Good luck,<br>Kristian Marcroft, Florian Pollini, Christian Speich & Team";
