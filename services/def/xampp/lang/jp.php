...
$TEXT['global-xampp']="XAMPP Mac OS Xﾅ";
...
$TEXT['security-text2']="緑のハイライトの表示は「安全」です。赤のハイライトの表示は、決定的に「要注意」、黄色のハイライトは「確認不能」(例えば、確認したいソフトウェアが稼動していないなど)です。<p>そのような問題をすべて修正するには、単純に<p><b>/Applications/xampp/xamppfiels/xampp security</b><p>をコールしてください。インタラクティブなプログラムが開始されます。";
...
$TEXT['security-checkmysql-text']="Mac OS X Box上のローカルユーザであれば誰でもあなたのMySQLデータベースに管理者権限でアクセスできます。パスワードを設定してください。";

$TEXT['security-checkftppassword-nok']="ユーザnobody のFTPパスワードが「xampp」のままです";
$TEXT['security-checkftppassword-ok']="ユーザnobody のFTPパスワードが「xampp」から変更されました";
...
$TEXT['start-head']="XAMPP Mac OS X版へようこそ";
...
$TEXT['start-text3']="PHPまたはPerl（またはその他）でプログラミングを開始したい場合、まず<a target=extern href=http://www.apachefriends.org/xampp-en.html>XAMPP manual</a> を参照して、XAMPPのインストールについて詳細情報を入手してください。";

$TEXT['start-text4']="グッドラック！<br>Kristian Marcroft, Florian Pollini, Christian Speich & Team";
