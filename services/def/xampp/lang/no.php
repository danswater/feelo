...
$TEXT['security-checkmysql-text']="Hver lokal Mac OS Xmaskin kan få tilgang til din MySql database med administrator rettigheter. Du BURDE sette et passord.";
...
$TEXT['security-checkftppassword-text']="Hvis FTP serveren var startet, standardbrukeren 'nobody' med passordet  'xampp' kan laste opp å endre filer på XAMPP webserveren.";
...
$TEXT['start-head']="Velkommen til XAMPP for Mac OS X";
...
$TEXT['start-text6']="Lykke Til,<br />Kristian Marcroft, Florian Pollini, Christian Speich & Team";
