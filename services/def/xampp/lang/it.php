...
$TEXT['global-xampp']="XAMPP per Mac OS X";
...
$TEXT['security-checkmysql-text']="Qualsiasi utente locale su Mac OS X può accedere a MySQL con diritti di amministrazione. E' consigliata una password.";

$TEXT['security-checkftppassword-nok']="La password FTP per l'utente nobody è ancora 'xampp'";
...
$TEXT['start-head']="Benvenuto in XAMPP per Mac OS X";
...
$TEXT['start-text3']="Se volessi iniziare la programmazione PHP o Perl (or whatever ;) visita per favore <a target=extern href=http://www.apachefriends.org/xampp-en.html>XAMPP manual</a> per ricevere maggiori informazioni sull'installazione di XAMPP.";

$TEXT['start-text4']="In bocca al lupo,<br>Kristian Marcroft, Florian Pollini, Christian Speich & Team";
