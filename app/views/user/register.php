<div id="loginFormBackground">
	<div class="createAccountCanvas instantAnimation fadeInDown">
		...
		<form id="loginForm" ng-submit="authenticate(loginForm)" name="loginForm">
			...
			<input type="text" ng-model="username" name="username" placeholder="Email" class="test" required/> <br/>
			<span ng-show="loginForm.username.$dirty && loginForm.username.$invalid && loginForm.username.$error.required">Email is required.</span> <br/>
			...
			<span ng-show="loginForm.username.$dirty && loginForm.username.$invalid && loginForm.username.$error.required">Timezone is required.</span> <br/>
			...
			<input type="submit" value="Create Account" class="loginButton" style="background-color: #222; padding: 20px;" />
		</form>
	</div>
</div>
